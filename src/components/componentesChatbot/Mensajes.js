...
function Mensajes(props){
    ...
    const  stylos = chat.who == 'bot' ? "flex max-w-[100%]  justify-self-start p-2 shadow-sm bg-colorm gap-4 rounded-t-2xl rounded-br-2xl break-words" : "max-w-[60%] justify-self-end p-2 bg-coloru rounded-l-2xl rounded-tr-2xl "
