...
console.log(card)
  return(
   ...
   <div>
      ...
      <div  className=" w-80 h-80 z-20 bg-colorwo rounded-2xl grid grid-rows-2 ">
      ...
      <span  className="final w-full h-1/4"><img src='{}' alt='imagen no disponible' className="w-full rounded-2xl object-cover"></img> </span>
